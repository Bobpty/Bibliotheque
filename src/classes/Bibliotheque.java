...
public class Bibliotheque implements Emprunter
{
	...
	public void creerUnDVD(String titreMedia, String realAutInt, Date dateParution, float prixHT, int dureeLocation, int uneDuree) {
		unDVD = new DVD(titreMedia, realAutInt, dateParution, prixHT, dureeLocation, uneDuree);
	}
	
	public void creerUnCD(String titreMedia, String realAutInt, Date dateParution, float prixHT, int dureeLocation, int unNbChanson)
	{
		unCD = new CD(titreMedia, realAutInt, dateParution, prixHT, dureeLocation, unNbChanson);
	}
	
	public void creerUnLivre(String titreMedia, String realAutInt, Date dateParution, float prixHT, int dureeLocation, int unNbPages)
	{
